...
def create_subdomain_directory(sender, instance, created, **kwargs):
    if created:
        ...
        try:
            ...
            # Copia o arquivo index.html para o diretório do subdomínio
            ...
            # Cria o link simbólico no home do usuário /var/www/members/{username}/{subdomain}
            ...
            if not os.path.exists(symlink_path):
                ...
                # Alterar a permissão do link simbólico para o usuário e grupo corretos
...
def exclude_subdomain_linux(sender, instance, **kwargs):
    # Diretório home do usuário /var/www/members/{username}
    user_home_directory = instance.member.get_home_directory_path()

    # Link simbólico no home do usuário /var/www/members/{username}/{subdomain}
